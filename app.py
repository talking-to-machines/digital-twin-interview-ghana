...
def log_survey_responses(
    ...
    try:
        ...
        data = (
            ...
            wave,
            treatment,
            survey_responses.args.get("email_recontact", "NA").strip() or "NA",
            survey_responses.args.get("first_name", "NA").strip() or "NA",
            survey_responses.args.get("last_name", "NA").strip() or "NA",
            survey_responses.args.get("phone_number", "NA").strip() or "NA",
            survey_responses.args.get("phone_owner", "NA").strip() or "NA",
            survey_responses.args.get("phone_number_backup", "NA").strip() or "NA",
            survey_responses.args.get("consent_social_media", "NA").strip() or "NA",
            survey_responses.args.get("has_paypal", "NA").strip() or "NA",
            survey_responses.args.get("paypal_email", "NA").strip() or "NA",
            survey_responses.args.get("paypal_email_confirm", "NA").strip() or "NA",
            survey_responses.args.get("twitter", "NA").strip() or "NA",
            survey_responses.args.get("tiktok", "NA").strip() or "NA",
            survey_responses.args.get("ethnicity", "NA").strip() or "NA",
            survey_responses.args.get("ethnicity_other", "NA").strip() or "NA",
            survey_responses.args.get("gender_other", "NA").strip() or "NA",
            survey_responses.args.get("UK_region", "NA").strip() or "NA",
            survey_responses.args.get("UK_district", "NA").strip() or "NA",
            survey_responses.args.get("US_state", "NA").strip() or "NA",
            survey_responses.args.get("US_county", "NA").strip() or "NA",
            survey_responses.args.get("Ghana_region", "NA").strip() or "NA",
            survey_responses.args.get("Ghana_district", "NA").strip() or "NA",
            survey_responses.args.get("zip", "NA").strip() or "NA",
            survey_responses.args.get("Q1_1", "NA").strip() or "NA",
            survey_responses.args.get("Q1_2", "NA").strip() or "NA",
            survey_responses.args.get("religiosity", "NA").strip() or "NA",
            survey_responses.args.get("religion", "NA").strip() or "NA",
            survey_responses.args.get("Q1_3", "NA").strip() or "NA",
            survey_responses.args.get("Q1_4", "NA").strip() or "NA",
            survey_responses.args.get("Q1_5", "NA").strip() or "NA",
            survey_responses.args.get("Q1_6", "NA").strip() or "NA",
            survey_responses.args.get("Q1_7", "NA").strip() or "NA",
            survey_responses.args.get("Q1_8", "NA").strip() or "NA",
            survey_responses.args.get("has_children", "NA").strip() or "NA",
            survey_responses.args.get("children_age", "NA").strip() or "NA",
            survey_responses.args.get("Q2", "NA").strip() or "NA",
            survey_responses.args.get("Q3_1", "NA").strip() or "NA",
            survey_responses.args.get("Q3_2", "NA").strip() or "NA",
            survey_responses.args.get("Q3_3", "NA").strip() or "NA",
            survey_responses.args.get("Q3_4", "NA").strip() or "NA",
            survey_responses.args.get("Q3_5", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_tuberculosis", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_mumps", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_polio", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_pneumococcal", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_rotavirus", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_rsv", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_rubella", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_tetanus", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_whooping_cough", "NA").strip()
            or "NA",
            survey_responses.args.get("familiarity_influenza", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_diphtheria", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_meningitis", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_hepatitis_a", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_hepatitis_b", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_hpv", "NA").strip() or "NA",
            survey_responses.args.get("familiarity_shingles", "NA").strip() or "NA",
            survey_responses.args.get("Q4_2", "NA").strip() or "NA",
            survey_responses.args.get("Q4_3", "NA").strip() or "NA",
            survey_responses.args.get("wellbeing_cheerful", "NA").strip() or "NA",
            survey_responses.args.get("wellbeing_calm", "NA").strip() or "NA",
            survey_responses.args.get("wellbeing_active", "NA").strip() or "NA",
            survey_responses.args.get("wellbeing_fresh", "NA").strip() or "NA",
            survey_responses.args.get("wellbeing_interested", "NA").strip() or "NA",
            survey_responses.args.get("trust_relatives", "NA").strip() or "NA",
            survey_responses.args.get("trust_neighbors", "NA").strip() or "NA",
            survey_responses.args.get("trust_own_tribe", "NA").strip() or "NA",
            survey_responses.args.get("trust_other_tribes", "NA").strip() or "NA",
            survey_responses.args.get("trust_chiefs", "NA").strip() or "NA",
            survey_responses.args.get("trust_district_assemblies", "NA").strip()
            or "NA",
            survey_responses.args.get("trust_police", "NA").strip() or "NA",
            survey_responses.args.get("trust_courts", "NA").strip() or "NA",
            survey_responses.args.get("trust_parties", "NA").strip() or "NA",
            survey_responses.args.get("trust_army", "NA").strip() or "NA",
            survey_responses.args.get("trust_parliament", "NA").strip() or "NA",
            survey_responses.args.get("trust_president", "NA").strip() or "NA",
            survey_responses.args.get("trust_gbc", "NA").strip() or "NA",
            survey_responses.args.get("trust_electoral_commission", "NA").strip()
            or "NA",
            survey_responses.args.get("trust_churches", "NA").strip() or "NA",
            survey_responses.args.get("trust_mosques", "NA").strip() or "NA",
            survey_responses.args.get("trust_unions", "NA").strip() or "NA",
            survey_responses.args.get("trust_banks", "NA").strip() or "NA",
            survey_responses.args.get("trust_businesses", "NA").strip() or "NA",
            survey_responses.args.get("Q6_2", "NA").strip() or "NA",
            survey_responses.args.get("Q6_3", "NA").strip() or "NA",
            survey_responses.args.get("Q6_4", "NA").strip() or "NA",
            survey_responses.args.get("Q6_5", "NA").strip() or "NA",
            survey_responses.args.get("Q6_6", "NA").strip() or "NA",
            survey_responses.args.get("Q6_8", "NA").strip() or "NA",
            survey_responses.args.get("open_video", "NA").strip() or "NA",
            survey_responses.args.get("Q8_2", "NA").strip() or "NA",
            survey_responses.args.get("Q8_3", "NA").strip() or "NA",
            survey_responses.args.get("Q8_4", "NA").strip() or "NA",
            survey_responses.args.get("Q8_5", "NA").strip() or "NA",
            survey_responses.args.get("Q8_6", "NA").strip() or "NA",
            survey_responses.args.get("Q8_7", "NA").strip() or "NA",
            survey_responses.args.get("Q8_8", "NA").strip() or "NA",
            survey_responses.args.get("Q8_9", "NA").strip() or "NA",
            survey_responses.args.get("Q8_10", "NA").strip() or "NA",
            survey_responses.args.get("Q8_11", "NA").strip() or "NA",
            survey_responses.args.get("Q8_12", "NA").strip() or "NA",
            survey_responses.args.get("Q8_13", "NA").strip() or "NA",
            survey_responses.args.get("Q8_14", "NA").strip() or "NA",
            datetime.now(),
        )
...
def inject_survey_responses(
    ...
    for placeholder, arg_name in prompt_placeholders.items():
        value = request.args.get(arg_name, "NA").strip() or "NA"
